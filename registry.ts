...
import dateGroupDayStatisticsCase from "./cases/aggregation/y1281-a-day-of-rows-and-one-total.case";
import formulaBranchAlertCase from "./cases/formula/y1282-a-branch-that-was-not-taken.case";
import wideWindowSocketLoadCase from "./cases/realtime/y1286-a-long-table-opened-on-a-page.case";
import provisionWindowReadRaceCase from "./cases/table/y1287-a-table-being-changed-is-still-there.case";
import numberShowAsClearedCase from "./cases/field/y1288-turning-off-a-bar-turns-it-off.case";
import sharePickerEmailOracleCase from "./cases/base-share/y1289-a-shared-picker-and-an-email-address.case";
import wholeBaseShareReplayCase from "./cases/base-share/y1290-a-share-link-and-somebody-elses-base.case";
import sidewaysPhotoDimensionsCase from "./cases/attachment/y1291-a-photo-taken-sideways.case";
import twoWayLinkDeleteCleanupCase from "./cases/link/y1292-a-deleted-row-stops-being-named.case";
import pluginSecretInListCase from "./cases/plugin/y1293-the-list-of-plugins-and-a-secret.case";
import uploadPathFromTheClientCase from "./cases/attachment/y1294-where-an-upload-lands.case";
import oauthScopeNotWidenedCase from "./cases/authority/y1295-an-approved-app-and-everything-else.case";
import hiddenNodeStillReferencedCase from "./cases/authority/y1296-a-withheld-table-named-in-its-folder.case";
import tokenReachesItsOwnArtifactCase from "./cases/authority/y1297-a-token-reads-back-what-it-made.case";
import formSubmitFlagCannotBrickCase from "./cases/base-share/y1298-a-shared-form-that-refuses-everybody.case";
import linkPickerForeignScopeCase from "./cases/authority/y1299-a-link-picker-that-offers-nothing.case";
import restrictedCannotShareABaseCase from "./cases/authority/y1300-sharing-a-view-and-sharing-the-base.case";
import searchHiddenFieldInlinedViewCase from "./cases/search/y1283-a-search-inside-a-view-that-hides-a-column.case";
import dateGroupMonthStatisticsCase from "./cases/aggregation/y1284-a-month-of-rows-and-one-total.case";
import rollupExpressionConvertCase from "./cases/lookup/y1285-turn-a-list-of-people-into-a-count.case";
...
import conditionalLookupReturnChainCase from "./cases/lookup/what-is-left-reaches-every-detail-row.case";
...
import selectRollupUniqueAndCountCase from "./cases/lookup/y1279-distinct-choices-in-the-order-they-appear.case";
import jsonbLookupAggregateCase from "./cases/lookup/y1280-the-largest-of-a-borrowed-list.case";
...
const cases = [
  ...
  conditionalLookupReturnChainCase,
