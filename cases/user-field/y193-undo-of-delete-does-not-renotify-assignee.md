# user-field/y193-undo-of-delete-does-not-renotify-assignee

**T6663** — fixed. One of three cases on the `user-field-notify-replay` runner;
this file carries the parts they share. Sibling of
`user-field/y194-undo-of-clear-does-not-renotify-assignee`, which covers the update
...
assignee_), and `user-field/y195-assignment-burst-arrives-coalesced`. Both are
