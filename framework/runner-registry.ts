...
import { runAuthorityComputedActivityCapabilityCase } from "./runners/authority-computed-activity-capability.runner";
...
const runners: { [K in BugRunnerKind]: RunnerFn<K> } = {
  ...
  "authority-computed-activity-capability":
    runAuthorityComputedActivityCapabilityCase,
